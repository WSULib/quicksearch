...
function parse_usmarc_string($record){
    ...
    foreach($record as $category){
        ...
        switch(substr($parts[0],0,3)){
            ...
            case "600" : $ret["dcterms.subject.personalname" . $i] = get_subfield_value($parts,$i); break;
            case "610" : $ret["dcterms.subject.corporatename" . $i] = get_subfield_value($parts,$i); break;            
            case "611" : $ret["dcterms.subject.meetingname" . $i] = get_subfield_value($parts,$i); break;
            case "630" : $ret["dcterms.subject.uniformtitle" . $i] = get_subfield_value($parts,$i); break;
            case "648" : $ret["dcterms.subject.chronologicalterm" . $i] = get_subfield_value($parts,$i); break;                        
