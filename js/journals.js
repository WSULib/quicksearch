    ...
    function journals_query(search_string) {
        ...
        $(document).ready(function() {
            ...
            function Success(response) {
                ...
                if (typeof journal_object.PAGEINFO !== 'undefined') {
                  if (journal_object.PAGEINFO.ENTRYCOUNT !== '0') {
                      ...
                      if (journal_object.PAGEINFO.ENTRYCOUNT === '1') {
                          ...
                          $("#journals .box_results").append("<a href='" + url + "'>" + title + "</a>");
                          $("#journals .box_results").append("<hr><span><a href='http://elibrary.wayne.edu/search~/?searchtype=X&searcharg=" + search_string + "&searchscope=17'><em>View more results... <span style='font-style:normal;'>(" + intFormatCommas(count) + ")</span></em></a></span>");
                          ...
                          $("#journals .box_results").append("<a href='http://elibrary.wayne.edu/search~/?searchtype=X&searcharg=" + search_string + "&searchscope=17'><em>View more results... <span style='font-style:normal;'>(" + intFormatCommas(count) + ")</span></em></a>");
                      } else {
                          for (var i = 0; i < 3; i++) {
                              //make some shortened variables for the data you want to mess with
                              count = journal_object.Heading.HeadingSize;
                    ...
                    //$("#journals .box_results").append("<div class=\"no-res\">No results found. Try another search in <a href='http://elibrary.wayne.edu/search~S17'>Catalog</a></div>");
                }
                //If no results, then display no results found
                //alert(typeof journal_object.PAGEINFO);
                if (typeof journal_object.PAGEINFO === 'undefined' || journal_object.PAGEINFO.ENTRYCOUNT === '0') {

                    //$("#journals .box_results").append("<div class=\"no-res\">No results found. Try another search in <a href='http://elibrary.wayne.edu/search~S17'>Catalog</a></div>");
                    $("#journals .box_results").append("<div class=\"no-res\">No results found. Try another search in <a href='http://elibrary.wayne.edu/search~/?searchtype=t&searcharg="+search_string+"&searchscope=17&SORT=D&submit=Search'>Catalog</a></div>");
                }
            }
