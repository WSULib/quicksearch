...
if (books_object.bookTotal === 1) {
  ...
  if (!books_object.bibNum[0]) {
    ...
    $("#books .box_results").append("<div class='indiv-result'><p class='title'><a href='"+url+"'>"+title+"</a></p></div>");
          ...
          var stackviewLink = (books_object.MatType[0] == "PRINT" && books_object.lc[i] !== null) ? "<a href='http://library.wayne.edu/test/cole/stackview-master/?q="+books_object.lc[0]+"' target='_blank'> <b>See on Shelf</b> <i class='glyphicon glyphicon-share-alt'></i></a><br/>": " <br/>";
...
for (var i = 0; i < 2; i++) {
      ...
      if (!books_object.bibNum[i]) {
        ...
        $("#books .box_results").append("<div class='indiv-result'><p class='title'><a href='"+url+"'>"+title+"</a></p></div>");
          ...
          var holdingStatus = (isEmpty(TypeofHoldingStatus)) ? "" : TypeofHoldingStatus;
          var stackviewLink = (books_object.MatType[i] == "PRINT" && books_object.lc[i] !== null) ? "<a href='http://library.wayne.edu/test/cole/stackview-master/?q="+books_object.lc[i]+"' target='_blank'> <b>See on Shelf</b> <i class='glyphicon glyphicon-share-alt'></i></a><br/>": " <br/>";
          var lc = (books_object.lc[i] == null) ? "" : "<br/>"+books_object.lc[i]+"";
          $("#books .box_results").append("<div class='indiv-result'><p class='title'><a href='"+url+"'>"+title+"</a>"+stackviewLink+holdingStatus+lc+"</p></div>");
        }
      }
